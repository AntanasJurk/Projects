...
public class SearchEN extends javax.swing.JFrame {
    final void FillList()
    {
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchEN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

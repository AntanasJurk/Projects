...
public class AddStudentEN extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(Name2Text, javax.swing.GroupLayout.DEFAULT_SIZE, 153, Short.MAX_VALUE)))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(26, 26, 26)))
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(IdText, javax.swing.GroupLayout.DEFAULT_SIZE, 154, Short.MAX_VALUE)
                                    .addComponent(cText)
                                    .addComponent(lText))))
    ...
    private void AddBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddBtnActionPerformed
        ...
        try
        {
            ...
            String Query="INSERT INTO STUDENTAS (VARDAS, PAVARDE, STUDID) VALUES ('"+NameText.getText()+"' , '"+Name2Text.getText()+"' , '"+IdText.getText()+"')";
            
             stnt.execute(Query);
            String Query2="INSERT INTO KURSAS (NAME, LENGTH) VALUES ('"+cText.getText()+"' , "+lText.getText()+")";
            stnt.execute(Query2);
            JOptionPane.showMessageDialog(null, "Prideta");
                         
            NameText.setText("Name");
            Name2Text.setText("Surname");
            IdText.setText("ID");
            cText.setText("Course");
            lText.setText("Legth");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddStudentEN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddStudentEN().setVisible(true);
            }
        });
    }
